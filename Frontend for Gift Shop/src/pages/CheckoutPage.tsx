...
import { formatPrice, deliveryZones } from "../data/mockData";
...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setErrors({});
    setLoading(true);
    // Simulate FedaPay redirect + payment
          ...
          <div>
            <div className="bg-card border border-border rounded-2xl p-6 sticky top-24">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-6 flex items-center justify-center gap-2 bg-primary text-white font-bold py-4 rounded-xl hover:bg-primary/90 transition-colors disabled:opacity-70"
              >
                {loading ? (
                  <>
