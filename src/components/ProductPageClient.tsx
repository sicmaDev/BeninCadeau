      ...
      <div className="grid lg:grid-cols-2 gap-10 mb-16">
        ...
        <div>
          <div className="relative rounded-2xl overflow-hidden aspect-square bg-muted mb-4">
            <img
              src={product.images[selectedImage] || "/1-19.png"}
              alt={product.name}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border ${
              product.stock > 5 ? "bg-secondary text-accent border-accent/20" :
              product.stock > 0 ? "bg-amber-100 text-amber-700 border-amber-200" : "bg-red-100 text-red-700 border-red-200"
            }`}>
              <span className={`w-1.5 h-1.5 rounded-full ${product.stock > 5 ? "bg-accent" : product.stock > 0 ? "bg-amber-500" : "bg-red-500"}`} />
          ...
          {/* Description */}
          <p className="text-muted-foreground leading-relaxed mb-8 text-sm whitespace-pre-line">{product.description}</p>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex items-center border border-border rounded-xl overflow-hidden bg-card">
              ...
              <span className="px-4 py-2.5 font-semibold text-sm min-w-[3rem] text-center text-foreground">{quantity}</span>
              <button
